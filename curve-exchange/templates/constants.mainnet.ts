...
export const EURTUSD_POOL = "0x9838eccc42659fa8aa7daf2ad134b53984c9427b";
export const EURTUSD_LP_TOKEN = "0x3b6831c0077a1e44ed0a21841c3bc4dc11bce833";
...
addressToPool.set(
  EURTUSD_POOL,
  new PoolStaticInfo(EURTUSD_POOL, EURTUSD_LP_TOKEN, 2, "META", false, [])
);
...
lpTokenToPool.set(EURTUSD_LP_TOKEN, EURTUSD_POOL);
