...
import {
  ...
  TokenExchange,
} from "../generated/templates/PoolLPToken/StableSwapPlain3";
import {
  ADDRESS_ZERO,
  getOrCreateAccount,
  investInMarket,
...
fakeBlock.hash = Bytes.fromHexString(
  "0x2d76f2a7c4f083b9f889611734104cfb1efa0cfef8e52b753d9c719870a49b98"
) as Bytes;
...
export function handleTransfer(event: Transfer): void {
  ...
  let pool = getOrCreatePool(
    event,
    Address.fromString(lpToken.pool),
    lpTokenAddress,
    [],
    CurvePoolType.PLAIN,
    coinCount
